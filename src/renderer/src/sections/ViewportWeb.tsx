import "../scss/sections/_viewport-web.scss";

import { FrameWeb } from "@renderer/components/DeviceFrames";
...
export const ViewportWeb: Component<{
	project: Project;
